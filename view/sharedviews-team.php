...
define('INTERNAL', 1);
define('MENUITEM', 'myportfolio/sharedviews-team');
...
$sortoptions = array(
    'lastchanged' => get_string('lastupdate'),
    'mtime'       => get_string('lastupdateorcomment'),
...
//$share = $queryparams['share'] = $sharedefault = array('user', 'friend', 'group', 'loggedin', 'public');
$share = $queryparams['share'] = $sharedefault = array('group');
