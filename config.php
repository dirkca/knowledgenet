 ...
 */
 $cfg->wwwroot = 'https://www.knowledgenet.ca/';
 ...
 */
$cfg->passwordsaltalt1 = 'sare si piperUncomment the following line if this server is not a production system.';
$cfg->passwordsaltmain = 'binenoThis will put a line up the top of the page saying that it isnt a production';
...
//to troubleshoot the error A nonrecoverable error occurred. This probably means you have encountered a bug in the system
