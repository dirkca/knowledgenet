...
<div class="top-container">
    <div class="top-container-left"><a href="{$WWWROOT}"><img src="/theme/knowledgenet-v1/static/images/knowledgenet-logo.png" alt="{$sitename}"></a></div>
...
<div style="width:100%; display:block; margin:0 auto; border:0px solid magenta;">
    <img id="map2" src="{$WWWROOT}theme/knowledgenet-v1a/static/images/knowledge-net-factory.png" style="width:100%;" usemap="#map2">
...
<map name="map2">
    ...
    <area color="green" shape="rect" alt="Start Here" title="Start Here" coords="628,151,755,258" href="https://knowledgenet.ca/moodle/mod/feedback/complete_guest.php?id=1&courseid&gopage=0" target="_blank" />
