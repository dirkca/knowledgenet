...
<!--Custom Menu-->
<link rel="stylesheet" href="/theme/megamenu/css/mgmenu.css" type="text/css" media="screen" />
<link rel="stylesheet" href="/theme/megamenu/css/custom-mgmenu.css" type="text/css" media="screen" />

<!--<script type="application/javascript" src="/xxx/theme/megamenu/js/jquery.js"></script> --jQuery -->  
<script type="application/javascript" src="/theme/megamenu/js/mgmenu_plugins.js"></script><!-- Mega Menu Plugins -->
<script type="application/javascript" src="/theme/megamenu/js/mgmenu.js"></script><!-- Mega Menu Script -->
