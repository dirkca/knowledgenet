...
{/if}
    ...
    <div id="footer-wrap" {if $editing == true}class="editcontent"{/if}>
      <div id="footer">
        <div id="powered-by"><a href="http://www.icampus21.com/" target="_blank"> 
...
<!---Image map display scripts only when we need--->
...
<script src="https://www.knowledgenet.ca/theme/knowledgenet-v2/templates/imagemapster/jquery.imagemapster.js"></script>
...
$(document).ready(function ()
{
	$('#map2').mapster({
	singleSelect : true,
	render_highlight : { altImage : 'https://www.knowledgenet.ca/theme/knowledgenet-v2/static/images/knowledge-net-factory2.gif' },
    mapKey: 'color',
	fill : true, altImage : 'httpw://www.knowledgenet.ca/theme/knowledgenet-v2/static/images/knowledge-net-factory3.png',
	fillOpacity : 0.8,
	stroke : false,
	strokeColor : 'ff0000',
	strokeWidth : 1,
