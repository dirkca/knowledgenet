...
//Disable tabs on /interaction/forum ...
    $wonderings_page_id = (substr($_SERVER['REQUEST_URI'], 0, 18));
    ...
    //        if (!defined('NOGROUPMENU')) {
              if (!defined('NOGROUPMENU') && ($wonderings_page_id != '/interaction/forum')  ){
...
function mahara_standard_nav() {
    ...
    $menu = array(
        'interaction' => array(
            'path' => 'interaction',
            'url' => 'interaction/forum/view.php?id=1',
         //   'title' => get_string('interaction', 'interaction'),
            'title' => 'Wonderings',
            'weight' => 20,
            'accesskey' => 'w',
        ),

        'interaction/forum' => array(
            'path' => 'interaction/forum',
            'url' => 'interaction/forum/view.php?id=1',
           'title' => 'Wonderings',
            'weight' => 10,
            'accesskey' => 'f',
        ...
        'interaction/createwondering' => array(
            'path' => 'interaction/createwondering',
            'url' => 'interaction/forum/edittopic.php?forum=1',
            'title' => get_string('addtopic','interaction.forum'),
            'title' => 'Create a Wondering',
            'weight' => 30,
            'accesskey' => 'a',
        ),
        ...
        'myportfolio/views' => array(
            ...
            'url' => 'view/index.php',
            'title' => 'My Idea Builds',
            'weight' => 10,
        ),
        'myportfolio/sharedviews-team' => array(
            'path' => 'myportfolio/sharedviews-team',
            'url' => 'view/sharedviews-team.php',
            'title' => 'My Team Builds',
            'weight' => 20,
        ),  
        'myportfolio/collection' => array(
            'path' => 'myportfolio/collection',
            'url' => 'collection/index.php',
            'title' => 'My Idea Builds Collections',
            'weight' => 30,
        ),           
        'myportfolio/sharedviews' => array(
            'path' => 'myportfolio/sharedviews',
            'url' => 'view/sharedviews.php',
            'title' => 'Find Idea Builds',
            'weight' => 40,
        ),        
        ...
        'curricular-resources' => array(
            'path' => 'curricular-resources',
            'url' => 'curricular-resources',         
            'title' => 'Curricular Resources',
            'weight' => 50,
            'accesskey' => 'p',
        ),
     
        'curricular-resources/outcomes' => array(
            'path' => 'curricular-resources/outcomes',
            'url' => 'curricular-resources/view.php?id=172',
            'title' => 'Outcomes',
            'weight' => 10,
        ),
        'curricular-resources/competencies' => array(
            'path' => 'curricular-resources/competencies',
            'url' => 'curricular-resources/view.php?id=189',
            'title' => 'Competencies',
            'weight' => 20,
        ),       
        'curricular-resources/inclusive-education' => array(
            'path' => 'curricular-resources/inclusive-education',
            'url' => 'curricular-resources/view.php?id=91',
...
function right_nav() {
    ...
    $menu = array(
      ...
      'settings/profile' => array(
         ...
         'settings/profileicons' => array(
            'path' => 'settings/profileicons',
